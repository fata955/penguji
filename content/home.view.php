        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div class="my-auto">
                        <h5 class="page-title fs-21 mb-1">Beranda</h5>
                        <nav>
                ...
                <div class="container about-container">
                    ...
                    <div class="row about-main mb-5">
                        <div class="col-lg-8 col-md-8 col-sm-12 text-center">
                            <h1 class="mb-3 fw-semibold fs-46">Assalamualaikum <span class="text-primary fs-56">Warahmatullahi Wabarakatu</span></h1>
                                    ...
                                    <div class="counter-status md-mb-0">
                                        <div class="text-center mb-1">
                                            <svg class="about-icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                <path fill="#0162e8" d="M10.3125,16.09375a.99676.99676,0,0,1-.707-.293L6.793,12.98828A.99989.99989,0,0,1,8.207,11.57422l2.10547,2.10547L15.793,8.19922A.99989.99989,0,0,1,17.207,9.61328l-6.1875,6.1875A.99676.99676,0,0,1,10.3125,16.09375Z" opacity=".99" />
                                                <path fill="#5a9bf4" d="M12,2A10,10,0,1,0,22,12,10.01146,10.01146,0,0,0,12,2Zm5.207,7.61328-6.1875,6.1875a.99963.99963,0,0,1-1.41406,0L6.793,12.98828A.99989.99989,0,0,1,8.207,11.57422l2.10547,2.10547L15.793,8.19922A.99989.99989,0,0,1,17.207,9.61328Z" />
                                            </svg>
                                        </div>
                                        <div class="text-center">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="card border-0 bg-danger-transparent">
                                <div class="card-body">
                                    <div class="counter-status md-mb-0">
                                        <div class="text-center mb-1">
                                            <svg class="about-icons" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
