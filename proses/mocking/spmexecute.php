    ...
    if (!empty($_POST["dataspm"])) {
        ...
        // for ($loop = 1; $loop <= $hal; $loop++) {
            ...
            foreach ($dt as $row) {
                ...
                $data = mysqli_query($koneksi, "SELECT * FROM tspm where id_spm=$id") or die(mysqli_error($koneksi));
                ...
                if ($cek != null) {
                    ...
                    id_spm,nomor_spm,keterangan_spm,nilai_spm,tanggal_spm,id_skpd,jenis
                        ...
                        $eksekusi = mysqli_query($koneksi, $table2);

                    if (mysqli_query($koneksi, $tarik)) {
                        echo json_encode([
                            "statusCode" => 200,
